...
STANDARD_SLOTS = [
    ...
    ('catering_body',           'Catering — Body Text',         'Main copy describing catering services'),
    ...
    ('private_events_header',   'Private Events — Header',      'Heading for private events / buyout section'),
    ...
    def handle(self, *args, **options):
        if options['list']:
            ...
            for slot in slots:
                ...
                active_label = f" → active: {active}" if active else " → no active block"
